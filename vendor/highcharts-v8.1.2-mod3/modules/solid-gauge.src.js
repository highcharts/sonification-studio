...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/SolidGaugeSeries.js', [_modules['Core/Color.js'], _modules['Core/Globals.js'], _modules['mixins/legend-symbol.js'], _modules['Core/Utilities.js']], function (Color, H, LegendSymbolMixin, U) {
        /* *
         *
         *  Solid angular gauge module
         *
