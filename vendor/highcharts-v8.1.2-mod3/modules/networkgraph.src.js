...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Networkgraph/Networkgraph.js', [_modules['Core/Globals.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js'], _modules['mixins/nodes.js']], function (H, Point, U, NodesMixin) {
        /* *
         *
         *  Networkgraph series
         *
