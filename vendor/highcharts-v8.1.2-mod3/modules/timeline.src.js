...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/TimelineSeries.js', [_modules['Core/Globals.js'], _modules['mixins/legend-symbol.js'], _modules['Core/Series/Point.js'], _modules['Core/Renderer/SVG/SVGElement.js'], _modules['Core/Utilities.js']], function (H, LegendSymbolMixin, Point, SVGElement, U) {
        /* *
         *
         *  Timeline Series.
         *
