...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/SankeySeries.js', [_modules['Core/Globals.js'], _modules['mixins/nodes.js'], _modules['Core/Color.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js'], _modules['mixins/tree-series.js']], function (H, NodesMixin, Color, Point, U, mixinTreeSeries) {
        /* *
         *
         *  Sankey diagram module
         *
