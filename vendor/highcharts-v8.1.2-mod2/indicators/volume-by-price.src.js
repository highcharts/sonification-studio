...
(function (factory) {
    ...
    _registerModule(_modules, 'indicators/volume-by-price.src.js', [_modules['Core/Globals.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js']], function (H, Point, U) {
        /* *
         *
