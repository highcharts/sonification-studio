...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/treemap.src.js', [_modules['Core/Globals.js'], _modules['mixins/tree-series.js'], _modules['mixins/draw-point.js'], _modules['Core/Color.js'], _modules['mixins/legend-symbol.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js']], function (H, mixinTreeSeries, drawPoint, Color, LegendSymbolMixin, Point, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'modules/sunburst.src.js', [_modules['Core/Globals.js'], _modules['Core/Utilities.js'], _modules['mixins/centered-series.js'], _modules['mixins/draw-point.js'], _modules['mixins/tree-series.js']], function (H, U, centeredSeriesMixin, drawPoint, mixinTreeSeries) {
        /* *
         *
