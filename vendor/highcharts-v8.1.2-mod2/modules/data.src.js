...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/data.src.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js']], function (Chart, H, Point, U) {
        /* *
         *
         *  Data module
         *
