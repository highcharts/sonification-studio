...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/boost/boost-init.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js'], _modules['modules/boost/boost-utils.js'], _modules['modules/boost/boost-attach.js']], function (Chart, H, U, butils, createAndAttachRenderer) {
        /* *
         *
         *  Copyright (c) 2019-2020 Highsoft AS
         *
    ...
    _registerModule(_modules, 'modules/boost/boost-overrides.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js'], _modules['modules/boost/boost-utils.js'], _modules['modules/boost/boostables.js'], _modules['modules/boost/boostable-map.js']], function (Chart, H, Point, U, butils, boostable, boostableMap) {
        /* *
         *
         *  Copyright (c) 2019-2020 Highsoft AS
         *
