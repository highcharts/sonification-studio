...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/full-screen.src.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (Chart, H, U) {
        /* *
    ...
    _registerModule(_modules, 'modules/exporting.src.js', [_modules['Core/Chart/Chart.js'], _modules['mixins/navigation.js'], _modules['Core/Globals.js'], _modules['Core/Options.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js']], function (Chart, chartNavigationMixin, H, O, SVGRenderer, U) {
        /* *
         *
         *  Exporting module
         *
