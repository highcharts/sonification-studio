...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/cylinder.src.js', [_modules['Core/Globals.js'], _modules['Core/Color.js'], _modules['Extensions/Math3D.js'], _modules['Core/Utilities.js']], function (H, Color, Math3D, U) {
        /* *
         *
