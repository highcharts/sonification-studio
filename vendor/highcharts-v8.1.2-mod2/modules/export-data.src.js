...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/export-data.src.js', [_modules['Core/Axis/Axis.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js'], _modules['mixins/download-url.js']], function (Axis, Chart, H, U, downloadURLmodule) {
        /* *
         *
