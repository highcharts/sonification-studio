...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/offline-exporting.src.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js'], _modules['mixins/download-url.js']], function (Chart, H, SVGRenderer, U, downloadURLmodule) {
        /* *
         *
         *  Client side exporting module
         *
