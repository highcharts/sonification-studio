...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/treemap.src.js', [_modules['parts/Globals.js'], _modules['mixins/tree-series.js'], _modules['mixins/draw-point.js'], _modules['parts/Color.js'], _modules['parts/Utilities.js']], function (H, mixinTreeSeries, drawPoint, Color, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'modules/sunburst.src.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['mixins/draw-point.js'], _modules['mixins/tree-series.js']], function (H, U, drawPoint, mixinTreeSeries) {
        ...
        var CenteredSeriesMixin = H.CenteredSeriesMixin,
            ...
            isBoolean = function (x) {
                return typeof x === 'boolean';
        }, noop = H.noop, rad2deg = 180 / Math.PI, seriesType = H.seriesType, seriesTypes = H.seriesTypes, setTreeValues = mixinTreeSeries.setTreeValues, updateRootId = mixinTreeSeries.updateRootId;
