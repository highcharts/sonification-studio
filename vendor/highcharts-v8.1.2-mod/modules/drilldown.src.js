...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/drilldown.src.js', [_modules['parts/Chart.js'], _modules['parts/Color.js'], _modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['parts/Point.js'], _modules['parts/SVGRenderer.js'], _modules['parts/Tick.js'], _modules['Core/Utilities.js']], function (Chart, Color, H, O, Point, SVGRenderer, Tick, U) {
        /* *
         *
         *  Highcharts Drilldown module
         *
