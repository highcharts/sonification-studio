/**
 * @license Highmaps JS v8.1.2 (2020-07-07)
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'parts-map/MapAxis.js', [_modules['parts/Axis.js'], _modules['Core/Utilities.js']], function (Axis, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'parts-map/ColorAxis.js', [_modules['parts/Axis.js'], _modules['parts/Chart.js'], _modules['parts/Color.js'], _modules['Core/Globals.js'], _modules['parts/Legend.js'], _modules['mixins/legend-symbol.js'], _modules['parts/Point.js'], _modules['Core/Utilities.js']], function (Axis, Chart, Color, H, Legend, LegendSymbolMixin, Point, U) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
    ...
    _registerModule(_modules, 'parts-map/Map.js', [_modules['parts/Chart.js'], _modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['parts/SVGRenderer.js'], _modules['Core/Utilities.js']], function (Chart, H, O, SVGRenderer, U) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
