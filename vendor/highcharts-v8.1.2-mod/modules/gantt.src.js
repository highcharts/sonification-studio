/**
 * @license Highcharts Gantt JS v8.1.2 (2020-07-07)
 *
 * Gantt series
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'mixins/tree-series.js', [_modules['parts/Color.js'], _modules['Core/Utilities.js']], function (Color, U) {
        /* *
         *
         *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
         *
    ...
    _registerModule(_modules, 'parts-gantt/GridAxis.js', [_modules['parts/Axis.js'], _modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['parts/Tick.js'], _modules['Core/Utilities.js']], function (Axis, H, O, Tick, U) {
        /* *
         *
         *  (c) 2016 Highsoft AS
    ...
    _registerModule(_modules, 'modules/broken-axis.src.js', [_modules['parts/Axis.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js'], _modules['parts/Stacking.js']], function (Axis, H, U, StackItem) {
        /* *
         *
    ...
    _registerModule(_modules, 'parts-gantt/TreeGridAxis.js', [_modules['parts/Axis.js'], _modules['parts/Tick.js'], _modules['parts-gantt/Tree.js'], _modules['parts-gantt/TreeGridTick.js'], _modules['mixins/tree-series.js'], _modules['Core/Utilities.js']], function (Axis, Tick, Tree, TreeGridTick, TreeSeriesMixin, U) {
        /* *
         *
         *  (c) 2016 Highsoft AS
         *  Authors: Jon Arild Nygard
    ...
    _registerModule(_modules, 'parts-gantt/CurrentDateIndicator.js', [_modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['Core/Utilities.js'], _modules['parts/PlotLineOrBand.js']], function (H, O, U, PlotLineOrBand) {
        /* *
         *
         *  (c) 2016-2020 Highsoft AS
         *
    ...
    _registerModule(_modules, 'parts-gantt/Pathfinder.js', [_modules['parts/Chart.js'], _modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['parts/Point.js'], _modules['Core/Utilities.js'], _modules['parts-gantt/PathfinderAlgorithms.js']], function (Chart, H, O, Point, U, pathfinderAlgorithms) {
        /* *
         *
         *  (c) 2016 Highsoft AS
    ...
    _registerModule(_modules, 'modules/xrange.src.js', [_modules['parts/Axis.js'], _modules['Core/Globals.js'], _modules['parts/Color.js'], _modules['parts/Point.js'], _modules['Core/Utilities.js']], function (Axis, H, Color, Point, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'parts-gantt/GanttSeries.js', [_modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['Core/Utilities.js']], function (H, O, U) {
        /* *
         *
         *  (c) 2016-2020 Highsoft AS
         *
    ...
    _registerModule(_modules, 'parts/ScrollbarAxis.js', [_modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (H, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'parts/Scrollbar.js', [_modules['parts/Axis.js'], _modules['Core/Globals.js'], _modules['parts/ScrollbarAxis.js'], _modules['Core/Utilities.js'], _modules['parts/Options.js']], function (Axis, H, ScrollbarAxis, U, O) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
    ...
    _registerModule(_modules, 'parts/RangeSelector.js', [_modules['parts/Axis.js'], _modules['parts/Chart.js'], _modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['parts/SVGElement.js'], _modules['Core/Utilities.js']], function (Axis, Chart, H, O, SVGElement, U) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
    ...
    _registerModule(_modules, 'parts/NavigatorAxis.js', [_modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (H, U) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
    ...
    _registerModule(_modules, 'parts/Navigator.js', [_modules['parts/Axis.js'], _modules['parts/Chart.js'], _modules['parts/Color.js'], _modules['Core/Globals.js'], _modules['parts/NavigatorAxis.js'], _modules['parts/Options.js'], _modules['parts/Scrollbar.js'], _modules['Core/Utilities.js']], function (Axis, Chart, Color, H, NavigatorAxis, O, Scrollbar, U) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
