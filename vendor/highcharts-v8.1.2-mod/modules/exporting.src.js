...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/exporting.src.js', [_modules['parts/Chart.js'], _modules['mixins/navigation.js'], _modules['Core/Globals.js'], _modules['parts/Options.js'], _modules['parts/SVGRenderer.js'], _modules['Core/Utilities.js']], function (Chart, chartNavigationMixin, H, O, SVGRenderer, U) {
        /* *
         *
         *  Exporting module
         *
