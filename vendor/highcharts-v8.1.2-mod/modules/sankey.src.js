...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/sankey.src.js', [_modules['Core/Globals.js'], _modules['parts/Color.js'], _modules['parts/Point.js'], _modules['Core/Utilities.js'], _modules['mixins/tree-series.js']], function (H, Color, Point, U, mixinTreeSeries) {
        /* *
         *
         *  Sankey diagram module
         *
