...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/cylinder.src.js', [_modules['Core/Globals.js'], _modules['parts/Color.js'], _modules['parts-3d/Math.js'], _modules['Core/Utilities.js']], function (H, Color, Math3D, U) {
        /* *
         *
