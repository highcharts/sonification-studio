...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/boost/wgl-renderer.js', [_modules['Core/Globals.js'], _modules['modules/boost/wgl-shader.js'], _modules['modules/boost/wgl-vbuffer.js'], _modules['parts/Color.js'], _modules['Core/Utilities.js']], function (H, GLShader, GLVertexBuffer, Color, U) {
        /* *
         *
         *  Copyright (c) 2019-2020 Highsoft AS
         *
