...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/boost-canvas.src.js', [_modules['parts/Chart.js'], _modules['Core/Globals.js'], _modules['parts/Color.js'], _modules['Core/Utilities.js']], function (Chart, H, Color, U) {
        /* *
         *
         *  License: www.highcharts.com/license
