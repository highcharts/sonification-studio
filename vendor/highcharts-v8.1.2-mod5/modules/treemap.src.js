...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/TreemapSeries.js', [_modules['Core/Globals.js'], _modules['Mixins/ColorMapSeries.js'], _modules['Mixins/TreeSeries.js'], _modules['Mixins/DrawPoint.js'], _modules['Core/Color.js'], _modules['Mixins/LegendSymbol.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js']], function (H, colorMapMixin, mixinTreeSeries, drawPointModule, Color, LegendSymbolMixin, Point, U) {
        /* *
         *
