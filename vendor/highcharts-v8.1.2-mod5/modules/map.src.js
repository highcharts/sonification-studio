/**
 * @license Highmaps JS v8.2.0 (2020-08-27)
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/MapSeries.js', [_modules['Core/Globals.js'], _modules['Mixins/LegendSymbol.js'], _modules['Maps/Map.js'], _modules['Core/Series/Point.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js'], _modules['Mixins/ColorMapSeries.js']], function (H, LegendSymbolMixin, mapModule, Point, SVGRenderer, U, colorMapMixin) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
    ...
    _registerModule(_modules, 'Series/HeatmapSeries.js', [_modules['Core/Globals.js'], _modules['Mixins/LegendSymbol.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Utilities.js'], _modules['Mixins/ColorMapSeries.js']], function (H, LegendSymbolMixin, SVGRenderer, U, colorMapMixin) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
